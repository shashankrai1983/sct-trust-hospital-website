                  ...
                  <div key={link.title} className="relative" onMouseEnter={() => toggleSubmenu(link.title)} onMouseLeave={() => setActiveSubmenu(null)}>
                    <div className="flex items-center">
                      ...
                      <button 
                        ...
                        className={cn(
                          "relative cursor-pointer text-sm font-semibold px-2 py-2 rounded-full transition-colors flex items-center",
                          "text-text-brown/80 hover:text-primary-green",
                          isActive && "text-primary-green"
                        )}
                      >
                    ...
                    {link.submenu ? (
                      <>
                        <div className="flex items-center justify-between w-full">
                          <Link
                            href={link.href}
                            className="flex-1 text-text-brown hover:text-primary-green transition-colors py-2"
                            onClick={() => {
                          ...
                          <button 
                            ...
                            className="p-2 text-text-brown hover:text-primary-green transition-colors"
                          >
